...
const galleriesData = [
  ...
  { id: 6, title: "Galeria7", image: "https://via.placeholder.com/300" },
];
  ...
  return (
    <>
      ...
      <main className="py-16 bg-white overflow-x-hidden">
        <div
          id="home"
          className="container m-auto px-6 space-y-8 text-gray-500 md:px-12 lg:px-20"
        >
          <div className="flex flex-col justify-center items-start gap-6 md:flex-row md:items-center lg:gap-16 relative">
            ...
            >
              ...
              <h1 className="text-4xl text-gray-700 font-bold md:text-5xl mb-2 md:-mt-48 z-40">
                ...
                <span className="text-[#7C5E44]"> Histórias.</span>
              </h1>
            </motion.div>
          </div>
        </div>
      ...
      >
        ...
        />
        <VelocityScroll
          text="Casamentos Festas Aniversários Formaturas Eventos"
          defaultVelocity={1}
